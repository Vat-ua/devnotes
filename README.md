...
Labs vivem em `content/labs/<slug>/`, com `meta.js`, `Lab.jsx` e, opcionalmente, `guide.mdx`. O registry local encontra os dois formatos automaticamente; não é necessário editar uma lista central para publicar um novo conteúdo.
