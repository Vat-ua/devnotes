...
export const codeFiles = [
  ...
  {
    name: 'FilterBar.jsx',
    description: 'Controles que escrevem busca, categoria e ordem na URL.',
    source: filterBarSource,
  },
  {
    name: 'ToolCard.jsx',
    description: 'Card de apresentação para uma ferramenta.',
    source: toolCardSource,
  },
  {
    name: 'ToolCatalog.jsx',
    description: 'Parâmetros da URL, lista derivada e atualização dos filtros.',
    source: catalogSource,
  },
  {
    name: 'styles.css',
    description: 'Estilos isolados da interface do catálogo.',
    source: stylesSource,
  },
];
