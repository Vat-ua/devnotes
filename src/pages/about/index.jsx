  ...
  return (
    <main className="about-page">
      <section className="about-hero container">
        ...
        <p>
          DevNotes é um lugar para pensar melhor antes de construir — com notas, exemplos e
          experimentos sobre as pequenas decisões que definem uma experiência digital.
        </p>
      </section>
      ...
      <section className="about-manifesto">
        <div className="container about-manifesto-inner">
          ...
          <div>
            <p>
              Boa parte do trabalho em desenvolvimento não pede uma ferramenta nova. Pede tempo para
              entender melhor o problema, tornar as escolhas explícitas e testar uma ideia antes de
              transformá-la em padrão.
            </p>
            <p>
              DevNotes reúne esse tipo de aprendizado em formatos curtos, diretos e fáceis de
              revisitar.
            </p>
          </div>
        </div>
