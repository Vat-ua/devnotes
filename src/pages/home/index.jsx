        ...
        <div className="container hero-layout">
          <div className="hero-copy">
            ...
            <p className="hero-lead">
              Notas práticas, explicações diretas e pequenos experimentos para transformar
              curiosidade em produto.
            </p>
      ...
      <section className="content-section" id="articles">
        <div className="container">
          <header className="section-header">
            ...
            <p>
              Ideias sobre as escolhas por trás de interfaces, código e produtos que funcionam no
              mundo real.
            </p>
          </header>
          ...
          <Link className="section-link" to="/articles">
            Ver todos os artigos <ArrowRight aria-hidden="true" size={18} />
          </Link>
        </div>
      </section>

      <section className="labs-preview" id="labs">
        <div className="container">
          <header className="section-header">
            <div>
              <h2>
            ...
            <p>
              Pequenas experiências interativas para testar ideias e comportamentos antes de
          ...
          <Link className="section-link" to="/labs">
            Explorar todos os labs <ArrowRight aria-hidden="true" size={18} />
          </Link>
        </div>
      </section>
