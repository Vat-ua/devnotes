...
- Use o prose system em `src/styles/content.css` para MDX e Shiki para code blocks. O highlighter dos Labs deve continuar lazy-loaded e limitado às linguagens realmente usadas.
