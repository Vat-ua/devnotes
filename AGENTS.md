...
- O conteúdo é local e file-based: Articles ficam em `content/articles/<slug>/index.mdx`; Labs em `content/labs/<slug>/` com `meta.js`, `Lab.jsx` e `guide.mdx` opcional. O registry em `src/content/registry.js` encontra o conteúdo automaticamente.
